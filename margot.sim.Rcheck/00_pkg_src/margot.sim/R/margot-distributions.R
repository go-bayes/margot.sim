...
#'
#' @param dist A parametric distribution object
#' @param n Number of values to generate
#' @param linear_predictor Optional linear predictor values
#'
#' @return Vector of generated values
...
#'
#' @param dist A custom distribution object
#' @param n Number of values to generate
#' @param linear_predictor Optional linear predictor values
#'
#' @return Vector of generated values
...
#' @param validate_distributions Logical. Validate distribution specifications? Default: TRUE
#'
