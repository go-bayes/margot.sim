---
title: "Applying Observational Shadows"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Applying Observational Shadows}
...
Real-world observational data is often a "shadow" of the true underlying process. The `margot.sim` package implements various types of observational distortions through its shadow system. This vignette demonstrates how to apply these shadows to simulated data.
...
## Real-World Example: Selection Bias
...
1. **Document your shadows**: Keep track of what distortions you've applied
2. **Validate assumptions**: Check if your shadow parameters are realistic
3. **Compare results**: Always compare analyses on clean vs shadowed data
4. **Use Monte Carlo**: For systematic evaluation, use `margot_monte_carlo()`

## Summary

The shadow system in `margot.sim` allows you to:
- Add realistic observational distortions to simulated data
- Combine multiple types of bias and measurement issues
- Systematically evaluate how these affect your analyses
- Better understand the robustness of statistical methods
